...
type UsageResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Usage         map[string]*Usage      `protobuf:"bytes,1,rep,name=usage,proto3" json:"usage,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // map of endpoints to usage
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
